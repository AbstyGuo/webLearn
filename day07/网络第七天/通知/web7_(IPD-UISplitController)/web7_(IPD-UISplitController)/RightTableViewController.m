...
- (void)viewDidLoad {
   ...
   //一直监听通知
    ...
    [[NSNotificationCenter defaultCenter]addObserver:self selector:@selector(getIndexPath:) name:@"1558" object:nil];
...
-(void)getIndexPath:(NSNotification *)noti{
...
-(void)dealloc{
    ...
    [[NSNotificationCenter defaultCenter]removeObserver:self name:@"1558" object:nil];
}
